...
// dipindahkan ke folder yang kita buat
    ...
    $sql = "INSERT INTO tb_produk (nama_produk, deskripsi, harga, gambar, id_kategori)
            VALUES ('$nama_produk', '$deskripsi', '$harga', '$nama_gambar', '$id_kategori')
    ";
            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="active"><a class="nav-link" href="index_produk.php"><i
                                    class="fas fa-columns"></i>Produk</a></li>
                        <li class=""><a class="nav-link" href="../data_kategori/index_kategori.php"><i
