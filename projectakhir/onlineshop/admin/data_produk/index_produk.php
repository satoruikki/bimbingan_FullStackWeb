                  ...
                  <div class="card-body">
                    <table class="table">
                      ...
                      <?php
                        ...
                        $sql = 'SELECT a.*, b.nama_kategori as kategori FROM tb_produk a JOIN tb_kategori b ON a.id_kategori = b.id ';
                        ...
                        <tr>
                          <th scope="row"><?= $i++ ?></th>
                          <td>
                            <img src="../../assets/upload/produk/<?= $row['gambar'] ?>" width="150" alt="">
                          </td>
