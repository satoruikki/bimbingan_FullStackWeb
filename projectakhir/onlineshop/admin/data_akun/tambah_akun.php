...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO tb_akun (nama_lengkap, username, email, alamat, password, foto, no_telpon)
            VALUES ('$nama_lengkap', '$username', '$email', '$alamat','$password', '$nama_gambar', '$no_telpon')
     ";
