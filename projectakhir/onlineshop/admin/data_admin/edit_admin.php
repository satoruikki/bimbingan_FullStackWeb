                        ...
                        <div class="row">
                            <div class="col-12 col-md-12 col-lg-12">
                                <form action="" method="POST">
                                    <input type="text" name="id" value="<?= $data_lama['id'] ?>"> 
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input required value="<?= $data_lama['nama_lengkap']?>" type="text" name="nama_lengkap"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="role" class="form-control">
                                                            ...
                                                            <option <?php $data_lama['role'] == 'admin' ? 'selected' : "" ?> value="admin">Admin</option>
                                                            <option <?php $data_lama['role'] == 'admin' ? 'selected' : "" ?> value="penjual">Penjual</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
