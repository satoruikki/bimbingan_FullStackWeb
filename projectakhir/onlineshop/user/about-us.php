...
<section class="section">
  <div class="container">
    <div class="row">
      <div class="col-lg-6">
        <div class="about-img">
          <img src="../assets/upload/muantap.jpg" class="img-fluid w-100 rounded" alt="" width="300px" height="200px" >
        </div>
      </div>
      <div class="col-lg-6 pt-5 pt-lg-0">
        <div class="about-content">
          <h3 class="font-weight-bold">Introduction</h3>
          <p>Toko Online ini didirakan oleh Group Sastra Mesin yang berpusat di kos Welly, Andre, Irsan</p>
          <h3 class="font-weight-bold">How we can help</h3>
          <p>Toko ini melayani untuk pembelian toko secara online, menyediakan berbagai barang </p>
        </div>
      </div>
    </div>
  </div>
